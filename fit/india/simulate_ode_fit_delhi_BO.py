...
import pandas as pd
import setproctitle
setproctitle.setproctitle('Delhi_SEIR@hanzhenyu')
...
def setup_args(parser=None):
    ...
    # Default Params
    parser.add_argument('--city_name', default='Delhi', help='City Name')
    parser.add_argument('--save_dir', default='./simulated_results_Delhi_2500/', help='Result Loc')
    parser.add_argument('--population_data', default='./population/delhi_pop.npy', help='Loc of pop data')
    ...
    parser.add_argument('--start_date', default='2021-03-22', help='Start Time')
    parser.add_argument('--change_point', default='2021-05-04', help='Interval of cases')
