...
import pandas as pd
import setproctitle
setproctitle.setproctitle('Mumbai_SEIR@hanzhenyu')
...
def setup_args(parser=None):
    ...
    # Default Params
    parser.add_argument('--city_name', default='Mumbai',help='City Name')
    parser.add_argument('--save_dir', default='./simulated_results_Mumbai_1681/', help='Result Loc')
    parser.add_argument('--population_data', default='./population/mumbai_pop.npy', help='Loc of pop data')
    ...
    parser.add_argument('--start_date', default='2021-02-11', help='Start Time')
    parser.add_argument('--change_point', default='2021-04-17', help='Interval of cases')
