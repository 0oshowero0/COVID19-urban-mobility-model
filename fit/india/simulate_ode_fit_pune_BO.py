...
import pandas as pd
import setproctitle
setproctitle.setproctitle('Pune_SEIR@hanzhenyu')
...
def setup_args(parser=None):
    ...
    # Default Params
    parser.add_argument('--city_name', default='Pune', help='City Name')
    parser.add_argument('--save_dir', default='./simulated_results_Pune_625/', help='Result Loc')
    parser.add_argument('--population_data', default='./population/pune_pop.npy', help='Loc of pop data')
    ...
    parser.add_argument('--start_date', default='2021-02-14', help='Start Time')
    parser.add_argument('--change_point', default='2021-05-14', help='Interval of cases')
