...
import pandas as pd
import setproctitle
setproctitle.setproctitle('Bengaluru_SEIR@hanzhenyu')
...
def setup_args(parser=None):
    ...
    # Default Params
    parser.add_argument('--city_name', default='Bengaluru Urban', help='City Name')
    parser.add_argument('--save_dir', default='./simulated_results_Bengaluru_3025/', help='Result Loc')
    parser.add_argument('--population_data', default='./population/bengaluru_pop.npy', help='Loc of pop data')
    parser.add_argument('--cases_data', default='./cases/India_epidemic_district_timeline.csv', help='Loc of cases data')
    parser.add_argument('--units', default=3025, help='Unit Num', type=int)
    parser.add_argument('--unit_distance', default=1, help='Unit distance between blocks(km)', type=int)
    parser.add_argument('--start_date', default='2021-03-12', help='Start Time')
    parser.add_argument('--change_point', default='2021-05-01', help='Interval of cases')
