...
import setproctitle
setproctitle.setproctitle('Ocean_SEIR@hanzhenyu')
...
def setup_args(parser=None):
    ...
    # 定义基本参数
    parser.add_argument('--population_data', default='./population/ocean_pop.npy', help='Loc of pop data')
    parser.add_argument('--cases_data', default='./cases/ocean.npy', help='Loc of cases data')
...
def multi_process_fit(i,fit_epoch):
    output_dir = Path('./simulated_results_Ocean_1521/')
