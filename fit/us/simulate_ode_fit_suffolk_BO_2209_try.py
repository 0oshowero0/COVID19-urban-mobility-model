...
import setproctitle
setproctitle.setproctitle('Suffolk_SEIR@hanzhenyu')
...
def setup_args(parser=None):
    ...
    # Default Params
    parser.add_argument('--population_data', default='./population/suffolk_pop.npy', help='Loc of pop data')
    parser.add_argument('--cases_data', default='./cases/suffolk.npy', help='Loc of cases data')
    parser.add_argument('--units', default=2209, help='Unit Num', type=int)
...
def multi_process_fit(i,fit_epoch):
    output_dir = Path('./simulated_results_Suffolk_2209/')
    ...
    cases_data_first = cases_data[53:70-6+7]
