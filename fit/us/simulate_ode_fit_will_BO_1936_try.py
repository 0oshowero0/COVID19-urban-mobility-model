...
import setproctitle
setproctitle.setproctitle('Will_SEIR@hanzhenyu')
...
def setup_args(parser=None):
    ...
    # Default Params
    parser.add_argument('--population_data', default='./population/will_pop.npy', help='Loc of pop data')
    parser.add_argument('--cases_data', default='./cases/will.npy', help='Loc of cases data')
...
def multi_process_fit(i,fit_epoch):
    output_dir = Path('./simulated_results_Will_1936/')
    ...
    cases_data_first = cases_data[58:70-6+14]
