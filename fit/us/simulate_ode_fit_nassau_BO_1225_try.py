...
import setproctitle
setproctitle.setproctitle('Nassau_SEIR@hanzhenyu')
...
def setup_args(parser=None):
    ...
    # Default Params
    parser.add_argument('--population_data', default='./population/nassau_pop.npy', help='Loc of pop data')
    parser.add_argument('--cases_data', default='./cases/nassau.npy', help='Loc of cases data')
    parser.add_argument('--units', default=1225, help='Unit Num', type=int)
...
def multi_process_fit(i,fit_epoch):
    output_dir = Path('./simulated_results_Nassau_1225/')
