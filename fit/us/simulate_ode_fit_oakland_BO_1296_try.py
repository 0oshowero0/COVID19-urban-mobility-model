...
import setproctitle
setproctitle.setproctitle('Oakland_SEIR@hanzhenyu')
...
def setup_args(parser=None):
    ...
    # Default Params
    parser.add_argument('--population_data', default='./population/oakland_pop.npy', help='Loc of pop data')
    parser.add_argument('--cases_data', default='./cases/oakland.npy', help='Loc of cases data')
...
def multi_process_fit(i,fit_epoch):
    output_dir = Path('./simulated_results_Oakland_1296/')
    ...
    cases_data_first = cases_data[57:70-6+7]
