...
import setproctitle
setproctitle.setproctitle('Davidson_SEIR@hanzhenyu')
...
def setup_args(parser=None):
    ...
    # Default Params
    parser.add_argument('--population_data', default='./population/davidson_pop.npy', help='Loc of pop data')
    parser.add_argument('--cases_data', default='./cases/davidson.npy', help='Loc of cases data')
...
def multi_process_fit(i,fit_epoch):
    output_dir = Path('./simulated_results_Davidson_900/')
