...
import pandas as pd
import setproctitle
setproctitle.setproctitle('SaoPaulo_SEIR@hanzhenyu')
...
def setup_args(parser=None):
    ...
    # Default Params
    parser.add_argument('--city_name', default='S_£o Paulo', help='City Name')
    parser.add_argument('--save_dir', default='./simulated_results_SaoPaulo_2500/', help='Result Loc')
    parser.add_argument('--population_data', default='./population/saoPaulo_pop.npy', help='Loc of pop data')
    ...
    parser.add_argument('--change_point', default='2021-03-10', help='Interval of cases')
