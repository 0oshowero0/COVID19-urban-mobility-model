...
import pandas as pd
import setproctitle
setproctitle.setproctitle('Belo Horizonte_SEIR@hanzhenyu')
...
def setup_args(parser=None):
    ...
    # Default Params
    parser.add_argument('--city_name', default='Belo Horizonte', help='City Name')
    parser.add_argument('--save_dir', default='./simulated_results_BeloHorizonte_900/', help='Result Loc')
    parser.add_argument('--population_data', default='./population/beloHorizonte_pop.npy', help='Loc of pop data')
    parser.add_argument('--cases_data', default='./cases/Brazil_epidemic_district_timeline.csv', help='Loc of cases data')
    parser.add_argument('--units', default=900, help='Unit Num', type=int)
    ...
    parser.add_argument('--change_point', default='2021-04-27', help='Interval of cases')
