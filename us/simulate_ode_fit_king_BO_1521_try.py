...
import setproctitle
setproctitle.setproctitle('King_SEIR@hanzhenyu')
...
def setup_args(parser=None):
    ...
    # Default Params
    parser.add_argument('--population_data', default='./population/king_pop.npy', help='Loc of pop data')
    parser.add_argument('--cases_data', default='./cases/king.npy', help='Loc of cases data')
...
def multi_process_fit(i,fit_epoch):
    output_dir = Path('./simulated_results_King_1521/')
    ...
    while error > 0.5:
        ...
        pbounds = {'pi': (0, 0.004), 'early_detect': (0, 1), 'mobility': (0, 0.0003)}
