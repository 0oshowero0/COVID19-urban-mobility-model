...
import setproctitle
setproctitle.setproctitle('Cook_SEIR@hanzhenyu')
...
def setup_args(parser=None):
    ...
    # Default Params
    parser.add_argument('--population_data', default='./population/cook_pop.npy', help='Loc of pop data')
    parser.add_argument('--cases_data', default='./cases/cook.npy', help='Loc of cases data')
    parser.add_argument('--units', default=2025, help='Unit Num', type=int)
    ...
    parser.add_argument('--Pi', default=5*1.4579062123726774e-05, help='transmission rate of I (to fit)', type=float)
    parser.add_argument('--Pe', default=5*1.4579062123726774e-05, help='transmission rate of E (the same with Pi)', type=float)
...
def multi_process_fit(i,fit_epoch):
    output_dir = Path('./simulated_results_Cook_2025/')
    ...
    cases_data_first = cases_data[48:70-6+7]
