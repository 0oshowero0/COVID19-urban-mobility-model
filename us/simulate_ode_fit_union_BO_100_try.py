...
import setproctitle
setproctitle.setproctitle('Union_SEIR@hanzhenyu')
...
def setup_args(parser=None):
    ...
    # Default Params
    parser.add_argument('--population_data', default='./population/union_pop.npy', help='Loc of pop data')
    parser.add_argument('--cases_data', default='./cases/union.npy', help='Loc of cases data')
    parser.add_argument('--units', default=100, help='Unit Num', type=int)
...
def multi_process_fit(i,fit_epoch):
    output_dir = Path('./simulated_results_Union_100/')
