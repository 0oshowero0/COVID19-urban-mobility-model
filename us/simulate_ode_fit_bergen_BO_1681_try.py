...
import setproctitle
setproctitle.setproctitle('Bergen_SEIR@hanzhenyu')
...
def setup_args(parser=None):
    ...
    # Default Params
    parser.add_argument('--population_data', default='./population/bergen_pop.npy', help='Loc of pop data')
    parser.add_argument('--cases_data', default='./cases/bergen.npy', help='Loc of cases data')
...
def multi_process_fit(i,fit_epoch):
    output_dir = Path('./simulated_results_Bergen_1681/')
    ...
    cases_data_first = cases_data[50:70-6+7]
