...
import setproctitle
setproctitle.setproctitle('Middlesex_SEIR@hanzhenyu')
...
def setup_args(parser=None):
    ...
    # Default Params
    parser.add_argument('--population_data', default='./population/middlesex_pop.npy', help='Loc of pop data')
    parser.add_argument('--cases_data', default='./cases/middlesex.npy', help='Loc of cases data')
    parser.add_argument('--units', default=961, help='Unit Num', type=int)
...
def multi_process_fit(i,fit_epoch):
    output_dir = Path('./simulated_results_Middlesex_961/')
    ...
    cases_data_first = cases_data[56:70-6+7]
