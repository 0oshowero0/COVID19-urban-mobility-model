...
import setproctitle
setproctitle.setproctitle('MiamiDade_SEIR@hanzhenyu')
...
def setup_args(parser=None):
    ...
    # 定义基本参数
    parser.add_argument('--population_data', default='./population/miami_dade_pop.npy', help='Loc of pop data')
    parser.add_argument('--cases_data', default='./cases/miami_dade.npy', help='Loc of cases data')
    parser.add_argument('--units', default=2304, help='Unit Num', type=int)
...
def multi_process_fit(i,fit_epoch):
    output_dir = Path('./simulated_results_MiamiDade_2304/')
