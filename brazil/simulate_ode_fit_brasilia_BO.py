...
import pandas as pd
import setproctitle
setproctitle.setproctitle('Brasilia_SEIR@hanzhenyu')
...
def setup_args(parser=None):
    ...
    # 定义基本参数
    parser.add_argument('--city_name', default='Bras_­lia', help='City Name')
    parser.add_argument('--save_dir', default='./simulated_results_Brasilia_2704/', help='Result Loc')
    parser.add_argument('--population_data', default='./population/brasilia_pop.npy', help='Loc of pop data')
    parser.add_argument('--cases_data', default='./cases/Brazil_epidemic_district_timeline.csv', help='Loc of cases data')
    parser.add_argument('--units', default=2704, help='Unit Num', type=int)
    ...
    parser.add_argument('--change_point', default='2021-02-23', help='Interval of cases')
